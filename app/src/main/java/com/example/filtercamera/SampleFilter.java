...
public final class SampleFilter {
    ...
    public static Filter Clarendon() {
        Point[] rgbKnots;
        rgbKnots = new Point[5];
        rgbKnots[0] = new Point(0, 0);
        rgbKnots[1] = new Point(80, 98);
        rgbKnots[2] = new Point(164, 159);
        rgbKnots[3] = new Point(211, 197);
    ...
    public static Filter Sunset() {
        Point[] rgbKnots;
        Point[] greenKnots;
        rgbKnots = new Point[5];
        rgbKnots[0] = new Point(0, 0);
        rgbKnots[1] = new Point(52, 62);
        rgbKnots[2] = new Point(140, 111);
        rgbKnots[3] = new Point(211, 184);
        rgbKnots[4] = new Point(255, 255);

        greenKnots = new Point[4];
        greenKnots[0] = new Point(0, 0);
        greenKnots[1] = new Point(105, 85);
        greenKnots[2] = new Point(165, 178);
    ...
    public static Filter Hefe() {
        Point[] rgbKnots;
        Point[] redKnots;
        rgbKnots = new Point[5];
        rgbKnots[0] = new Point(0, 0);
        rgbKnots[1] = new Point(54, 75);
        rgbKnots[2] = new Point(120, 147);
        rgbKnots[3] = new Point(205, 200);
        rgbKnots[4] = new Point(255, 255);

        redKnots = new Point[5];
        redKnots[0] = new Point(0, 0);
        redKnots[1] = new Point(30, 53);
        redKnots[2] = new Point(83, 133);
        redKnots[3] = new Point(157, 210);
    ...
    public static Filter xpro() {
        Point[] rgbKnots;
        Point[] blueKnots;

        rgbKnots = new Point[4];
        rgbKnots[0] = new Point(0, 0);
        rgbKnots[1] = new Point(137, 144);
        rgbKnots[2] = new Point(175, 199);
        rgbKnots[3] = new Point(255, 255);


        blueKnots = new Point[4];
        blueKnots[0] = new Point(0, 0);
        blueKnots[1] = new Point(53, 71);
        blueKnots[2] = new Point(153, 189);
